...
Feature: Manan app Form Page
   ...
   @auth
   Scenario: Verify user should be able to upload the pdf file with size less than 5MB
   Given user is on the Manan Form Page
   When User is uploading the pdf file with size less than 5MB
   Then The user should be able to see the file get uploaded successfully
...
@auth
   Scenario: Verify that user enter incorrect data for Current Medications field
      Given user is on the Manan Form Page
      When  User enter incorrect values in  Current Medications field
      Then The user should be able to see error message in Current Medications field
 ...
 @auth
    Scenario: Verify that user should be able to see alert message of subscription limit reached
       Given user is on the Manan Form Page
       When User enter all the deatils in the form
       Then The user should view the alert of subscription limit reached 